...
The inspiration for this comes from games such as "The Binding Of Issac" and old school acrade games.
...
4. Create a new branch for your changes or use the existing feature branch.
...
If you are contributing sprites, sounds, levels or maps, please follow the guidelines.

- Use clear file names, for example <code>skelton_archer.png</code>
